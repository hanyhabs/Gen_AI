...
def create_vector_embeddings():
    if "vectors" not in st.session_state:
        try:
            ...
            st.write(f"Loaded documents: {len(st.session_state.docs)}")
            ...
            if not st.session_state.final_documents:
                st.error("No documents found to process. Check document loading and splitting.")
                return
...
if user_prompt:
    ##creates a chain to pass a list of docs to a model
